...
const Navbar = () => {
  ...
  return (
    ...
    >
      {/* <nav className=" z-50 w-full bg-white-lilac text-gray-700 text-lg font-medium py-4 lg:py-4 px-4 shadow "> */}
      {/* container */}
      <div className="fixed top-0 left-0 w-full bg-white-lilac text-gray-700 text-lg font-medium py-4 px-4 shadow lg:py-4">
        {/* Navbar container */}
        <div className="mx-auto hidden lg:flex justify-between items-center px-5 lg:w-4/5 md:px-8 ">
          {/* Branding */}
          <div className="">
