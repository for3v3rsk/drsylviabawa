...
const Publications = ({ articles, books }) => {
  ...
  return (
    <section
      id="Publications"
      className="py-24 md:py-28 flex flex-col items-center bg-white-lilac publicationsBg min-h-screen"
    >
      {/* publications heading */}
      <h1 className="muli-bold mb-8 font-semibold text-2xl text-gray-700">
        Publications
      </h1>

      {/* published articles section */}
      <section className="lg:w-3/5 mx-5 mb-20">
